...
## Breakout: “고성능" 튜닝으로 Blazor 애플리케이션 개발을 시작해 봅시다! - Motoki Nakae님
...
## Breakout: ASP.NET Core 애플리케이션 모니터링 - 박정훈님
...
## Breakout: Serilog를 통해 애플리케이션 데이터를 수집하고 분석하기 - 이수호님

* **발표 자료**: [PPTX](Breakout-04-Serilog를 통해 애플리케이션 데이터를 수집하고 분석하자.pptx)
* **발표 영상 (공개 전)**:
[![닷넷콘 2023](../../dotNET_Dev.jpg)](https://www.youtube.com/c/닷넷데브)

---

## Breakout: 윈도우 기반 서버를 클라우드 친화적으로 바꾸는 법 (feat. 윈도우 컨테이너) - 남정현님
...
## Breakout: .NET Framework 기반 SaaS 솔루션 .NET 6 전환기 - 한재준님
...
## Breakout: 나만의 To-do 앱 빌드하기 (feat. Blazor & CosmosDB) - 강연정님
...
## Breakout: MAUI Community Toolkit을 활용한 효과적인 MAUI 앱 개발 - 조중현님
...
## Breakout: .NET 6와 Azure 액티브 디렉터리로 웹 애플리케이션 사용자 관리하기 - Mats Lundell-Nygjelten님
...
## Breakout: C# 11 static abstract members 이해와 대비 - 김주호님
...
## Breakout: 닷넷을 디버깅해 보자! - 오민석님

* **발표 자료**: [PPTX](Breakout-11-lets-debug-dotnet-min-seok-oh.pptx)
* **발표 영상 (공개 전)**:
[![닷넷콘 2023](../../dotNET_Dev.jpg)](https://www.youtube.com/c/닷넷데브)

---

## Breakout: 닷넷 도대체 안되는게 뭐지? - 이종인님

* **발표 자료**: [PPTX](Breakout-12-[이종인] .NET 안되는 게 뭔가요.pptx)
* **발표 영상 (공개 전)**:
[![닷넷콘 2023](../../dotNET_Dev.jpg)](https://www.youtube.com/c/닷넷데브)

---

## Breakout: MVVM Toolkit을 사용하려는 개발자를 위한 안내 - 박문찬님
...
## Birds-of-Feather: Windows Dev Kit 2023 체험해보기 - 이재웅님

* **발표 자료**: [PPTX](BirdsOfFeather-14-DevKit2023.pptx)

---

## Hands-on-Lab: Spread.NET과 함께하는 쾌-적 Excel 개발 - 이상준님
...
## Hands-on-Lab: 닷넷 개발자를 위한 깃헙 코드스페이스 설정 - Justin Yoo님
...
## Hands-on-Lab: SuperSocketLite로 고성능 Socket 서버 개발하기 - 최흥배님
...
## Hands-on-Lab: Stl.Fusion 소개 - 실시간 앱 서비스 만들기 - 정세일님
